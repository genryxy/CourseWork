...
namespace MobileAppPhoto
{
    ...
    public class ProductComposition
    {
        ...
        private readonly string[] _splitWords = {"не", "нЕ", "Не", ".", "•", " ", ":", "\t", "\n", "г,", "г.", "-", "—", "t", "r", ";",
                 "НЕ", "более", "менее", "больше", "меньше", "превышает", "ниже", "превышать", "щенные жир", "может", "ого\nжира",
                "его\nжир", "оо жир", "го жир", "ый жир", "ой жир", "щенных жир", "щенные\nжир", "щенных\nжир",  "ё"};
